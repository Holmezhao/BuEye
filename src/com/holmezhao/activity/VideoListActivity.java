...
public class VideoListActivity extends ListActivity implements
		OnItemLongClickListener {
	private String rootPath = null;
	private static final String media_path = "BuEye/video";
	// 存储文件名称
	...
	private void fileHandle(final File file) {
		...
		new AlertDialog.Builder(VideoListActivity.this).setTitle("请选择要进行的操作!")
	...
	private void displayToast(String message) {
		Toast.makeText(VideoListActivity.this, message, Toast.LENGTH_SHORT)
				.show();
	}
